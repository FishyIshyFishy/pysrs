...
@staticmethod
def lockin_scan(lockin_chan: str, galvo: Galvo) -> np.ndarray:
    ...
    cropped_data = data[galvo.numsteps_extra:-galvo.numsteps_extra, galvo.numsteps_extra:-galvo.numsteps_extra]
